...
int main() {
    ...
    // Lógica do jogo
  	...
  	while (tentativas > 0) {
        ...
        printf("%s\n", buffer); // Imprime "Sua vez de jogar."
        ...
        // Imprime a próxima mensagem do servidor
        printf("%s\n", buffer);
        ...
        if (strcmp(buffer, "Fim de jogo! Você perdeu.") == 0) {
            break;
        }
    	
    	if (strcmp(buffer, "Fim de jogo! Nenhum dos jogadores acertou o número.") == 0) {
      		break;
    	}
